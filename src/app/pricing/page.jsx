...
export default function PricingPage() {
  ...
  return (<main className="relative overflow-hidden bg-[#F8F5EF] min-h-screen py-20 px-5">
    {/* Background Effects */} <div className="absolute top-0 left-0 w-96 h-96 bg-[#D4A54A]/10 blur-[120px] rounded-full" />
